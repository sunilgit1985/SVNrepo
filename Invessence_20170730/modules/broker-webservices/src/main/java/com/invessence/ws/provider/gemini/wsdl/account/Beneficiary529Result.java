...
public class Beneficiary529Result  implements java.io.Serializable {
    ...
    private com.invessence.ws.provider.gemini.wsdl.account.GenderEnum gender;
    ...
    public Beneficiary529Result(
           ...
           com.invessence.ws.provider.gemini.wsdl.account.GenderEnum gender,
     ...
     * @return gender
     */
    public com.invessence.ws.provider.gemini.wsdl.account.GenderEnum getGender() {
        return gender;
    }
     ...
     * @param gender
     */
    public void setGender(com.invessence.ws.provider.gemini.wsdl.account.GenderEnum gender) {
        this.gender = gender;
    }
