...
public class PrepaidActivityCollectionResult  implements java.io.Serializable {
    private com.invessence.ws.provider.gemini.wsdl.account.PrepaidActivityResult[] prepaidActivities;
    ...
    public PrepaidActivityCollectionResult(
           com.invessence.ws.provider.gemini.wsdl.account.PrepaidActivityResult[] prepaidActivities,
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.PrepaidActivityResult[] getPrepaidActivities() {
        return prepaidActivities;
    }
     ...
     */
    public void setPrepaidActivities(com.invessence.ws.provider.gemini.wsdl.account.PrepaidActivityResult[] prepaidActivities) {
        this.prepaidActivities = prepaidActivities;
    }
