...
public class EdocsCollectionResult  implements java.io.Serializable {
    private com.invessence.ws.provider.gemini.wsdl.account.EdocsResult[] edocs;
    ...
    public EdocsCollectionResult(
           com.invessence.ws.provider.gemini.wsdl.account.EdocsResult[] edocs,
     ...
     * @return edocs
     */
    public com.invessence.ws.provider.gemini.wsdl.account.EdocsResult[] getEdocs() {
        return edocs;
    }
     ...
     * @param edocs
     */
    public void setEdocs(com.invessence.ws.provider.gemini.wsdl.account.EdocsResult[] edocs) {
        this.edocs = edocs;
    }
