drop procedure if exists invdb.sav_user_risk_questions;
delimiter $$
CREATE PROCEDURE invdb.sav_user_risk_questions(
     ...
     IN  p_riskByQuestion tinyint,
     In  p_riskOverride tinyint
  )
 BEGIN 
 			...
 			riskOverride,
  			...
  			VALUES (
                 ...
                 riskByQuestion=p_riskByQuestion,
 				riskOverride=p_riskOverride,
  				lastupdated = now()
                  ;
