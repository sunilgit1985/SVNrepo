drop procedure if exists rbsa.end_of_price_process;
delimiter $$
CREATE  PROCEDURE rbsa.end_of_price_process(in p_process varchar(20),in p_businessdate varchar(20) )
 BEGIN
  ...
  rd.prev_businessdate,rd.prev_close_price,rd.daily_return,rd.prev_month_businessdate,rd.prev_monthly_adjusted,rd.monthly_return,rd.converted_prev_adjusted,rd.converted_prev_monthly_adjusted,ifnull(rd.exchangeRate,1),ifnull(rd.base_currency,rd.dest_currency)
