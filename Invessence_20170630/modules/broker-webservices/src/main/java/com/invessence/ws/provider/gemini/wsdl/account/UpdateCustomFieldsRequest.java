...
public class UpdateCustomFieldsRequest  implements java.io.Serializable {
    private com.invessence.ws.provider.gemini.wsdl.account.AccountCustomFieldsRequest[] accountCustomFields;

    public UpdateCustomFieldsRequest() {
    }

    public UpdateCustomFieldsRequest(
           com.invessence.ws.provider.gemini.wsdl.account.AccountCustomFieldsRequest[] accountCustomFields) {
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.AccountCustomFieldsRequest[] getAccountCustomFields() {
        return accountCustomFields;
    }
     ...
     */
    public void setAccountCustomFields(com.invessence.ws.provider.gemini.wsdl.account.AccountCustomFieldsRequest[] accountCustomFields) {
        this.accountCustomFields = accountCustomFields;
    }
