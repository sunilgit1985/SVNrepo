...
public class PrepaidSummaryResult  implements java.io.Serializable {
    private com.invessence.ws.provider.gemini.wsdl.account.PrepaidSummaryInfo prepaidSummary;
    ...
    public PrepaidSummaryResult(
           com.invessence.ws.provider.gemini.wsdl.account.PrepaidSummaryInfo prepaidSummary,
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.PrepaidSummaryInfo getPrepaidSummary() {
        return prepaidSummary;
    }
     ...
     */
    public void setPrepaidSummary(com.invessence.ws.provider.gemini.wsdl.account.PrepaidSummaryInfo prepaidSummary) {
        this.prepaidSummary = prepaidSummary;
    }
