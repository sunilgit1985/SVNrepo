...
public class FileProcessorUtil
{
   ...
   static File getFileToProcess(String directory) throws IOException
   {
      ...
      return new File(localDirectory.getAbsolutePath() + File.separator + filesToProcess.get(0));
   }

   private static File determineLocalDirectory(String directory) throws IOException
   {
      Properties properties = new Properties();
      properties.load(FileProcessorUtil.class.getResourceAsStream("/ftp.properties"));
      return new File(properties.getProperty("ftp.localdir") + File.separator + directory);
   }
