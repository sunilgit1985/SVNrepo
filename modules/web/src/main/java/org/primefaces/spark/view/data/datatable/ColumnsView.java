 ...
 */
package org.primefaces.spark.view.data.datatable;
...
public class ColumnsView implements Serializable {
    ...
    private static List<String> VALID_COLUMN_KEYS = new ArrayList<String>(); // = Arrays.asList("id", "brand", "year", "color", "price");
