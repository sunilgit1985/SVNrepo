...
public class AccountMessageCollectionResult  implements java.io.Serializable {
    private com.invessence.ws.provider.gemini.wsdl.account.AccountMessageResult[] accountMessage;
    ...
    public AccountMessageCollectionResult(
           com.invessence.ws.provider.gemini.wsdl.account.AccountMessageResult[] accountMessage,
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.AccountMessageResult[] getAccountMessage() {
        return accountMessage;
    }
     ...
     */
    public void setAccountMessage(com.invessence.ws.provider.gemini.wsdl.account.AccountMessageResult[] accountMessage) {
        this.accountMessage = accountMessage;
    }
