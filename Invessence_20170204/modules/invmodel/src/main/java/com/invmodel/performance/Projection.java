...
public class Projection
{
   ...
   private static Projection instance = null;

   public static synchronized Projection getInstance()
   {
      if (instance == null)
      {
   ...
   public ProjectionData[] getPortfolioPerformance(AssetClass[] assetData, Portfolio[] portfolioData, int numOfYears)
   {

      ProjectionData[] perfData = null;
