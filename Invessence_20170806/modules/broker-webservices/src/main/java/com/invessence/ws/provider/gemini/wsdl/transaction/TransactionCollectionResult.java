...
public class TransactionCollectionResult  implements java.io.Serializable {
    ...
    private com.invessence.ws.provider.gemini.wsdl.transaction.TransactionResult[] transaction;

    private com.invessence.ws.provider.gemini.wsdl.transaction.TransactionMessageResult[] transactionMessageCollection;
    ...
    public TransactionCollectionResult(
           ...
           com.invessence.ws.provider.gemini.wsdl.transaction.TransactionResult[] transaction,
           com.invessence.ws.provider.gemini.wsdl.transaction.TransactionMessageResult[] transactionMessageCollection,
     ...
     * @return transaction
     */
    public com.invessence.ws.provider.gemini.wsdl.transaction.TransactionResult[] getTransaction() {
        return transaction;
    }
     ...
     * @param transaction
     */
    public void setTransaction(com.invessence.ws.provider.gemini.wsdl.transaction.TransactionResult[] transaction) {
        this.transaction = transaction;
    }
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.transaction.TransactionMessageResult[] getTransactionMessageCollection() {
        return transactionMessageCollection;
    }
     ...
     */
    public void setTransactionMessageCollection(com.invessence.ws.provider.gemini.wsdl.transaction.TransactionMessageResult[] transactionMessageCollection) {
        this.transactionMessageCollection = transactionMessageCollection;
    }
