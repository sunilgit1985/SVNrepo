...
public class FavoriteInstitutionsCollectionResult  implements java.io.Serializable {
    private com.invessence.ws.provider.gemini.wsdl.account.Institution[] favoriteInstitutions;
    ...
    public FavoriteInstitutionsCollectionResult(
           com.invessence.ws.provider.gemini.wsdl.account.Institution[] favoriteInstitutions,
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.Institution[] getFavoriteInstitutions() {
        return favoriteInstitutions;
    }
     ...
     */
    public void setFavoriteInstitutions(com.invessence.ws.provider.gemini.wsdl.account.Institution[] favoriteInstitutions) {
        this.favoriteInstitutions = favoriteInstitutions;
    }
