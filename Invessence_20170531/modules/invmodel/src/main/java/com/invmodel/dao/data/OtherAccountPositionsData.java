...
public class OtherAccountPositionsData implements Serializable
{
   ...
   public OtherAccountPositionsData()
   {
      super();
   ...
   public OtherAccountPositionsData(String theme, String asset, String displayname, double lbConstraint, double ubConstraint,
