...
public class PrepaidSummaryInfo  implements java.io.Serializable {
    ...
    private com.invessence.ws.provider.gemini.wsdl.account.PrepaidDetailResult[] prepaidDetails;
    ...
    public PrepaidSummaryInfo(
           ...
           com.invessence.ws.provider.gemini.wsdl.account.PrepaidDetailResult[] prepaidDetails) {
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.PrepaidDetailResult[] getPrepaidDetails() {
        return prepaidDetails;
    }
     ...
     */
    public void setPrepaidDetails(com.invessence.ws.provider.gemini.wsdl.account.PrepaidDetailResult[] prepaidDetails) {
        this.prepaidDetails = prepaidDetails;
    }
