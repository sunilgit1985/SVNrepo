...
public class AccountMessageCollectionRequest  implements java.io.Serializable {
    private com.ws.gemini.wsdl.account.AccountMessageRequest[] accountMessage;

    public AccountMessageCollectionRequest() {
    }

    public AccountMessageCollectionRequest(
           com.ws.gemini.wsdl.account.AccountMessageRequest[] accountMessage) {
     ...
     */
    public com.ws.gemini.wsdl.account.AccountMessageRequest[] getAccountMessage() {
        return accountMessage;
    }
     ...
     */
    public void setAccountMessage(com.ws.gemini.wsdl.account.AccountMessageRequest[] accountMessage) {
        this.accountMessage = accountMessage;
    }
