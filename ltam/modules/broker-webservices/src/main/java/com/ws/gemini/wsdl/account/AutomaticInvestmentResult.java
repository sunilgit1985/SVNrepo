...
public class AutomaticInvestmentResult  implements java.io.Serializable {
    ...
    private com.ws.gemini.wsdl.account.AIPFundInformationResult[] AIPFunds;

    private com.ws.gemini.wsdl.account.AutomaticInvestmentLinesResult[] automaticInvestmentLines;
    ...
    public AutomaticInvestmentResult(
           ...
           com.ws.gemini.wsdl.account.AIPFundInformationResult[] AIPFunds,
           com.ws.gemini.wsdl.account.AutomaticInvestmentLinesResult[] automaticInvestmentLines) {
     ...
     * @return AIPFunds
     */
    public com.ws.gemini.wsdl.account.AIPFundInformationResult[] getAIPFunds() {
        return AIPFunds;
    }
     ...
     * @param AIPFunds
     */
    public void setAIPFunds(com.ws.gemini.wsdl.account.AIPFundInformationResult[] AIPFunds) {
        this.AIPFunds = AIPFunds;
    }
     ...
     */
    public com.ws.gemini.wsdl.account.AutomaticInvestmentLinesResult[] getAutomaticInvestmentLines() {
        return automaticInvestmentLines;
    }
     ...
     */
    public void setAutomaticInvestmentLines(com.ws.gemini.wsdl.account.AutomaticInvestmentLinesResult[] automaticInvestmentLines) {
        this.automaticInvestmentLines = automaticInvestmentLines;
    }
