...
public class CDSCCalculatorResult  implements java.io.Serializable {
    ...
    private com.ws.gemini.wsdl.account.LotDetailResult[] lotDetails;
    ...
    public CDSCCalculatorResult(
           ...
           com.ws.gemini.wsdl.account.LotDetailResult[] lotDetails,
     ...
     * @return lotDetails
     */
    public com.ws.gemini.wsdl.account.LotDetailResult[] getLotDetails() {
        return lotDetails;
    }
     ...
     * @param lotDetails
     */
    public void setLotDetails(com.ws.gemini.wsdl.account.LotDetailResult[] lotDetails) {
        this.lotDetails = lotDetails;
    }
