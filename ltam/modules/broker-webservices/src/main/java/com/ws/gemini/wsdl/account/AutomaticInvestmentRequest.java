...
public class AutomaticInvestmentRequest  implements java.io.Serializable {
    ...
    private com.ws.gemini.wsdl.account.AIPFundInformation[] AIPFunds;
    ...
    public AutomaticInvestmentRequest(
           ...
           com.ws.gemini.wsdl.account.AIPFundInformation[] AIPFunds) {
     ...
     * @return AIPFunds
     */
    public com.ws.gemini.wsdl.account.AIPFundInformation[] getAIPFunds() {
        return AIPFunds;
    }
     ...
     * @param AIPFunds
     */
    public void setAIPFunds(com.ws.gemini.wsdl.account.AIPFundInformation[] AIPFunds) {
        this.AIPFunds = AIPFunds;
    }
