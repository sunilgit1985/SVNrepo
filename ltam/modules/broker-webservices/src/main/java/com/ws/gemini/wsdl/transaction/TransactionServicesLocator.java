...
public class TransactionServicesLocator extends org.apache.axis.client.Service implements com.ws.gemini.wsdl.transaction.TransactionServices {
    ...
    public com.ws.gemini.wsdl.transaction.TransactionServicesSoap_PortType getTransactionServicesSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.ws.gemini.wsdl.transaction.TransactionServicesSoap_PortType getTransactionServicesSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ws.gemini.wsdl.transaction.TransactionServicesSoap_BindingStub _stub = new com.ws.gemini.wsdl.transaction.TransactionServicesSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ws.gemini.wsdl.transaction.TransactionServicesSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ws.gemini.wsdl.transaction.TransactionServicesSoap_BindingStub _stub = new com.ws.gemini.wsdl.transaction.TransactionServicesSoap_BindingStub(new java.net.URL(TransactionServicesSoap_address), this);
                _stub.setPortName(getTransactionServicesSoapWSDDServiceName());
                return _stub;
            }
        }
