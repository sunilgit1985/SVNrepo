...
public class FundInformation  implements java.io.Serializable {
    ...
    private com.ws.gemini.wsdl.transaction.CBALotInformation[] CBALotInfo;
    ...
    public FundInformation(
           ...
           com.ws.gemini.wsdl.transaction.CBALotInformation[] CBALotInfo) {
           this.fundId = fundId;
     ...
     * @return CBALotInfo
     */
    public com.ws.gemini.wsdl.transaction.CBALotInformation[] getCBALotInfo() {
        return CBALotInfo;
    }
     ...
     * @param CBALotInfo
     */
    public void setCBALotInfo(com.ws.gemini.wsdl.transaction.CBALotInformation[] CBALotInfo) {
        this.CBALotInfo = CBALotInfo;
    }
