...
public class BalanceCollectionResult  implements java.io.Serializable {
    private com.ws.gemini.wsdl.account.BalanceResult[] balance;
    ...
    public BalanceCollectionResult(
           com.ws.gemini.wsdl.account.BalanceResult[] balance,
     ...
     * @return balance
     */
    public com.ws.gemini.wsdl.account.BalanceResult[] getBalance() {
        return balance;
    }
     ...
     * @param balance
     */
    public void setBalance(com.ws.gemini.wsdl.account.BalanceResult[] balance) {
        this.balance = balance;
    }
