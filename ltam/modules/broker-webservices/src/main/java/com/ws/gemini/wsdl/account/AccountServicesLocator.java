...
public class AccountServicesLocator extends org.apache.axis.client.Service implements com.ws.gemini.wsdl.account.AccountServices {
    ...
    public com.ws.gemini.wsdl.account.AccountServicesSoap_PortType getAccountServicesSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.ws.gemini.wsdl.account.AccountServicesSoap_PortType getAccountServicesSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ws.gemini.wsdl.account.AccountServicesSoap_BindingStub _stub = new com.ws.gemini.wsdl.account.AccountServicesSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ws.gemini.wsdl.account.AccountServicesSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ws.gemini.wsdl.account.AccountServicesSoap_BindingStub _stub = new com.ws.gemini.wsdl.account.AccountServicesSoap_BindingStub(new java.net.URL(AccountServicesSoap_address), this);
                _stub.setPortName(getAccountServicesSoapWSDDServiceName());
                return _stub;
            }
        }
