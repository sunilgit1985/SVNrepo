...
public class AchPayeeCollectionResult  implements java.io.Serializable {
    private com.ws.gemini.wsdl.account.AchPayeeResult[] achPayee;
    ...
    public AchPayeeCollectionResult(
           com.ws.gemini.wsdl.account.AchPayeeResult[] achPayee,
     ...
     * @return achPayee
     */
    public com.ws.gemini.wsdl.account.AchPayeeResult[] getAchPayee() {
        return achPayee;
    }
     ...
     * @param achPayee
     */
    public void setAchPayee(com.ws.gemini.wsdl.account.AchPayeeResult[] achPayee) {
        this.achPayee = achPayee;
    }
