...
public class UpdateFavoriteInstitutionsRequest  implements java.io.Serializable {
    ...
    private com.ws.gemini.wsdl.account.FavoriteInstitutionsRequest[] favoriteInstitutions;
    ...
    public UpdateFavoriteInstitutionsRequest(
           ...
           com.ws.gemini.wsdl.account.FavoriteInstitutionsRequest[] favoriteInstitutions) {
     ...
     */
    public com.ws.gemini.wsdl.account.FavoriteInstitutionsRequest[] getFavoriteInstitutions() {
        return favoriteInstitutions;
    }
     ...
     */
    public void setFavoriteInstitutions(com.ws.gemini.wsdl.account.FavoriteInstitutionsRequest[] favoriteInstitutions) {
        this.favoriteInstitutions = favoriteInstitutions;
    }
