...
public class SuccessorBeneficiaryResult  implements java.io.Serializable {
    ...
    private com.invessence.ws.provider.gemini.wsdl.account.MailingAddressesResult mailingAddresses;
    ...
    public SuccessorBeneficiaryResult(
           ...
           com.invessence.ws.provider.gemini.wsdl.account.MailingAddressesResult mailingAddresses) {
           this.userId = userId;
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.MailingAddressesResult getMailingAddresses() {
        return mailingAddresses;
    }
     ...
     */
    public void setMailingAddresses(com.invessence.ws.provider.gemini.wsdl.account.MailingAddressesResult mailingAddresses) {
        this.mailingAddresses = mailingAddresses;
    }
