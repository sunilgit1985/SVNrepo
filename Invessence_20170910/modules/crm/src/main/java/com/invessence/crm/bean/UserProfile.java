...
import com.invessence.crm.service.IConvertToRedTailBean;

/**
 * Created by abhangp on 11/22/2016.
 */
public class UserProfile implements IConvertToRedTailBean<User>
{
   private Long id;
   ...
   @Override
   public User convertToRedTailBean()
   {
      return new User(this.getUserName(),this.getUserName(),this.getEmail(),
                      this.getFirstName()
                      );
   }
}
