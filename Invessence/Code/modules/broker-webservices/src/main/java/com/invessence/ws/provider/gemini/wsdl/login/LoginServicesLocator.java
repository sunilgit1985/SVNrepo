...
public class LoginServicesLocator extends org.apache.axis.client.Service implements com.invessence.ws.provider.gemini.wsdl.login.LoginServices {
    ...
    private java.lang.String LoginServicesSoap_address = ServiceParameters.BROKER_WEBSERVICES_GEMINI_WS_END_POINT_URL +"/LoginServices.asmx";
    ...
    public com.invessence.ws.provider.gemini.wsdl.login.LoginServicesSoap_PortType getLoginServicesSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.invessence.ws.provider.gemini.wsdl.login.LoginServicesSoap_PortType getLoginServicesSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.invessence.ws.provider.gemini.wsdl.login.LoginServicesSoap_BindingStub _stub = new com.invessence.ws.provider.gemini.wsdl.login.LoginServicesSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.invessence.ws.provider.gemini.wsdl.login.LoginServicesSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.invessence.ws.provider.gemini.wsdl.login.LoginServicesSoap_BindingStub _stub = new com.invessence.ws.provider.gemini.wsdl.login.LoginServicesSoap_BindingStub(new java.net.URL(LoginServicesSoap_address), this);
                _stub.setPortName(getLoginServicesSoapWSDDServiceName());
                return _stub;
            }
        }
