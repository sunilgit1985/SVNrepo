...
public class Plan529AccountBalanceActivityCollectionResult  implements java.io.Serializable {
    ...
    private com.invessence.ws.provider.gemini.wsdl.account.Plan529AccountBalanceActivityResult[] accountBalanceActivity;
    ...
    public Plan529AccountBalanceActivityCollectionResult(
           ...
           com.invessence.ws.provider.gemini.wsdl.account.Plan529AccountBalanceActivityResult[] accountBalanceActivity) {
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.Plan529AccountBalanceActivityResult[] getAccountBalanceActivity() {
        return accountBalanceActivity;
    }
     ...
     */
    public void setAccountBalanceActivity(com.invessence.ws.provider.gemini.wsdl.account.Plan529AccountBalanceActivityResult[] accountBalanceActivity) {
        this.accountBalanceActivity = accountBalanceActivity;
    }
