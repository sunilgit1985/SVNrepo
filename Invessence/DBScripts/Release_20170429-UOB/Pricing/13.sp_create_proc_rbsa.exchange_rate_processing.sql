...
begin
 ...
 select currency_exchange_cd,multiplying_factor into p_exchngsymbol,p_multiplying_factor from invdb.sec_source_mapping where ticker_source_name=p_ticker;
