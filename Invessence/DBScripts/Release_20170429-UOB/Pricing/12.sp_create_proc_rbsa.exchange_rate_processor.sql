...
DELIMITER $$
USE rbsa$$
CREATE PROCEDURE exchange_rate_processor(in p_ticker varchar(20),in p_direction varchar(10),in p_exchngsymbol varchar(10),in p_insrtexchngsymbol varchar(20))
begin
