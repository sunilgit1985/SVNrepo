...
/*
  ...
  THEN
   BEGIN
      ...
      prev_close_price = v_prev_close_price,
      daily_return = v_daily_return,
      dest_currency=v_dest_currency,
      converted_adjusted_price=v_converted_adjusted_price
       WHERE
      ticker =v_ticker and
   ...
   END;
    ...
    BEGIN
       ...
       prev_businessdate,
       prev_close_price,
       daily_return, dest_currency,
      converted_adjusted_price
       ...
       v_prev_businessdate,
       v_prev_close_price,
       v_daily_return,v_dest_currency,v_converted_adjusted_price
        ) ;
    END;
  END IF;
  */
    ...
    ticker = v_ticker
  	...
  	if(r_count>0)
       ...
       begin
         ...
         daily_return=v_daily_return,
         prev_close_price=v_prev_close_price,
         volume=v_volume,dest_currency=v_dest_currency,converted_adjusted_price=v_converted_adjusted_price
         where
         ticker=v_ticker and
         businessdate=v_businessdate;
        ...
        INSERT INTO rbsa_daily
  		 	  (ticker,businessdate,open_price,close_price,high_price,low_price,adjusted_price,volume,prev_businessdate,prev_close_price,daily_return,prev_month_businessdate,prev_monthly_adjusted,monthly_return,dest_currency,converted_adjusted_price)
  	select ticker,businessdate,open_price,close_price,high_price,low_price,adjusted_price,volume,prev_businessdate,prev_close_price,daily_return,prev_month_businessdate,prev_monthly_adjusted,monthly_return,dest_currency,converted_adjusted_price
  	from tmp_rbsa_daily;
