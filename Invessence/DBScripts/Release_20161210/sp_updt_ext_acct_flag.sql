...
BEGIN
  ...
  the_loop: LOOP
    ...
    FETCH cur1 INTO tClientID, tAcctNum, tTotal, tAdvisor, tPortfolioName, tGoal, tAcctType, tName;
    ...
    END IF;
		...
		SET tMessage=concat('<strong>New Account opened and funded, Account#:',tClientID,'</strong>'
							,'<table>'
        ...
        -- select tClientID, tAcctNum, tTotal, tAdvisor, tPortfolioName, tGoal, tMessage;
		SET tMessage=concat('New Account opened and funded: \n\tAccount#: ',tClientID, ' \n\t,Type: ',tAcctType,' \n\t,Funded: ',tTotal,'\n\t,Strategy: ',tPortfolioName,'\n\t,Goal: ',tGoal);
