...
INSERT INTO `invdb`.`web_site_info` (`url`, `name`, `status`, `value`, `encrFlag`, `created`, `updated`) VALUES ('tmp', 'EMAIL.ACTIVATE.SUBJECT', 'A', 'Welcome to Tradition Advisers - Activate Your Account', 'N', null, null);
INSERT INTO `invdb`.`web_site_info` (`url`, `name`, `status`, `value`, `encrFlag`, `created`, `updated`) VALUES ('tmp', 'EMAIL.LOCKED.SUBJECT', 'A', 'Tradition Advisers - Account is locked', 'N', null, null);
INSERT INTO `invdb`.`web_site_info` (`url`, `name`, `status`, `value`, `encrFlag`, `created`, `updated`) VALUES ('tmp', 'EMAIL.RESET.SUBJECT', 'A', 'Tradition Advisers - Reset Your Password', 'N', null, null);
INSERT INTO `invdb`.`web_site_info` (`url`, `name`, `status`, `value`, `encrFlag`, `created`, `updated`) VALUES ('tmp', 'EMAIL.WELCOME.SUBJECT', 'A', 'Welcome to Tradition Advisers - Activate Your Account', 'N', null, null);
...
INSERT INTO `invdb`.`web_site_info` (`url`, `name`, `status`, `value`, `encrFlag`, `created`, `updated`) VALUES ('tmp', 'HTML.ACTIVATED', 'A', 'traditionadvisers-Activated.html', 'N', '2017-07-11 10:31:07', null);
INSERT INTO `invdb`.`web_site_info` (`url`, `name`, `status`, `value`, `encrFlag`, `created`, `updated`) VALUES ('tmp', 'EMAIL.FORGOT.SUBJECT', 'A', 'Tradition Advisers - Reset Your Password', 'N', '2017-07-11 10:31:07', null);

INSERT INTO `invdb`.`web_site_info` (`url`, `name`, `status`, `value`, `encrFlag`, `created`) VALUES ('tmp', 'SERVICE.PRODUCT', 'A', 'TCM', 'N', '2017-06-13 08:42:58');
INSERT INTO `invdb`.`web_site_info` (`url`, `name`, `status`, `value`, `encrFlag`, `created`) VALUES ('tmp', 'SERVICE.FILEPROCESS.MODE', 'I', '', 'N', '2017-05-30 07:03:12');
