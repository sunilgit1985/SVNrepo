...
INSERT INTO `invdb`.`adv_request_document_mappings` (`advisorid`, `action`, `subaction`, `reqType`, `envelopeHeading`, `seqno`, `formType`) VALUES ('2', 'FUNDING', 'ACAT2', 'TAI_ACAT_OTHER', 'Please sign account transfer document.', '1', 'DC');
...
INSERT INTO `invdb`.`adv_request_document_mappings` (`advisorid`, `action`, `subaction`, `reqType`, `envelopeHeading`, `seqno`, `formType`) VALUES ('2', 'ACCT_OPEN', 'ACAT2', 'TAI_ACAT_OTHER', 'Please sign account transfer document.', '3', 'DC');
...
INSERT INTO `invdb`.`adv_request_document_mappings` (`advisorid`, `action`, `subaction`, `reqType`, `envelopeHeading`, `seqno`, `formType`) VALUES ('3', 'FUNDING', 'ACAT2', 'TAE_ACAT_OTHER', 'Please sign account transfer document.', '1', 'DC');
...
INSERT INTO `invdb`.`adv_request_document_mappings` (`advisorid`, `action`, `subaction`, `reqType`, `envelopeHeading`, `seqno`, `formType`) VALUES ('3', 'ACCT_OPEN', 'ACAT2', 'TAE_ACAT_OTHER', 'Please sign account transfer document.', '3', 'DC');
...
INSERT INTO `invdb`.`adv_request_document_mappings` (`advisorid`, `action`, `subaction`, `reqType`, `envelopeHeading`, `seqno`, `formType`) VALUES ('4', 'FUNDING', 'ACAT2', 'TAI_ACAT_OTHER', 'Please sign account transfer document.', '1', 'DC');
...
INSERT INTO `invdb`.`adv_request_document_mappings` (`advisorid`, `action`, `subaction`, `reqType`, `envelopeHeading`, `seqno`, `formType`) VALUES ('4', 'ACCT_OPEN', 'ACAT2', 'TAI_ACAT_OTHER', 'Please sign account transfer document.', '3', 'DC');
