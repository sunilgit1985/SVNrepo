...
@Service("dcWebLayerClass")
public class DCWebLayerClassImpl implements DCWebLayerClass
{
   private static final Logger logger = Logger.getLogger(DCWebLayerClassImpl.class);
   @Autowired
