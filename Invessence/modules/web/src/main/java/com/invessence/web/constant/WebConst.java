...
public class WebConst
{
   ...
   public static String WEB_ADVISOR_INFO = "webadvisorinfo";
   ...
   */
   ...
   public final static String UOB_PATTERN_SINGAPORE_NRIC="^(?i)[STFG]\\d{7}[A-Z]$.*";
   public final static String UOB_PATTERN_MALAYSIAN_NRIC="\\d{6}\\-\\d{2}\\-\\d{4}";
