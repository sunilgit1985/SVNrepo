...
public class DCConstants
{
   ...
   public final static String SUB_ACTION_ACH_EFT = "ACH_EFT";
   public final static String SUB_ACTION_REC_EFT = "REC_EFT";
   public final static String SUB_ACTION_NEW_ACAT = "ACAT";
   public final static String SUB_ACTION_NEW_ACAT2 = "ACAT2";
   public final static String SUB_ACTION_NEW_TDTRF = "TDTRF";
   public final static String SUB_ACTION_ACCT_APP_NEW = "ACCT_APP_NEW";
