 ...
 */
public class BRRiskCalculator extends RiskCalculator
{
   ...
   public BRRiskCalculator(String goal,
   ...
   public BRRiskCalculator(Integer numberofQuestions)
   {
