...
import com.invessence.web.bean.consumer.nestegg.NestEggCharts;
...
public class PositionBean implements Serializable
{
   ...
   private NestEggCharts nestEggChart = new NestEggCharts();
   ...
   private void createPieModel()
   {
      ...
      if (managedAssetsMap.size() > 0)
      {
         ...
         nestEggChart.createPieModel(assetclassArray, 0);
         pieModel = nestEggChart.getPieChart();
      }
/*
      String seriescolor = "";
