...
//         notificationDataList = advisorListDAO.getAdvisorNotification(logonid, notificationType, filterNotice);
         notificationDataList = commonDAO.getNotificationDtls(webutil.getLogonid(),notificationType, filterNotice,webutil.getAccess(),false,0l, webutil.getUserInfoData().getAdvisor(), webutil.getUserInfoData().getRep());
      }
   }
