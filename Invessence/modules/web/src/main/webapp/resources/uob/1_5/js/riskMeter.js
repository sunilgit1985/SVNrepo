	...
	try{
		...
		var chartSpeed = Highcharts.chart(vChrtId, Highcharts.merge(gaugeOptions, {
			...
			series: [{
				...
				data: [vMeterVal],
				dataLabels: {
					format: '<div style="text-align:center;float:bottom;"><span style="font-size:20px;color:black;position:relative;top:63px;">{y}</span><br/>' +
					'<span style="font-size:10px;color:black;position:relative;top:6px;">'+vLableBottom+'</span></div>'
				},
				tooltip: {
