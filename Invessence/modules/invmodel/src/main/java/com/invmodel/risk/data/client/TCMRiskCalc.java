 ...
 */
public class TCMRiskCalc extends RiskCalc
{
   public TCMRiskCalc()
   {
      super();
   ...
   public TCMRiskCalc(UserRiskProfile userRiskProfile)
   {
      super(userRiskProfile);
   }

   public TCMRiskCalc(UserRiskProfile userRiskProfile, Long acctnum)
   {
