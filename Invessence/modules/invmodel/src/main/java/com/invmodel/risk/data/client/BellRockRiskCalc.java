 ...
 */
public class BellRockRiskCalc extends RiskCalc
{
   public BellRockRiskCalc()
   {
      super();
   }

   public BellRockRiskCalc(UserRiskProfile userRiskProfile)
   {
      super(userRiskProfile);
   }

   public BellRockRiskCalc(UserRiskProfile userRiskProfile, Long acctnum)
   {
