...
public class AuthorizedAccountCollectionResult  implements java.io.Serializable {
    private com.invessence.ws.provider.gemini.wsdl.account.AuthorizedAccountsResult[] authorizedAccounts;
    ...
    public AuthorizedAccountCollectionResult(
           com.invessence.ws.provider.gemini.wsdl.account.AuthorizedAccountsResult[] authorizedAccounts,
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.AuthorizedAccountsResult[] getAuthorizedAccounts() {
        return authorizedAccounts;
    }
     ...
     */
    public void setAuthorizedAccounts(com.invessence.ws.provider.gemini.wsdl.account.AuthorizedAccountsResult[] authorizedAccounts) {
        this.authorizedAccounts = authorizedAccounts;
    }
