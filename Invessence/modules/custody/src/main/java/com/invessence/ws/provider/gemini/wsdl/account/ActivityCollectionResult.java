...
public class ActivityCollectionResult  implements java.io.Serializable {
    ...
    private com.invessence.ws.provider.gemini.wsdl.account.ActivityResult[] activity;
    ...
    public ActivityCollectionResult(
           ...
           com.invessence.ws.provider.gemini.wsdl.account.ActivityResult[] activity,
           int totalRows) {
     ...
     * @return activity
     */
    public com.invessence.ws.provider.gemini.wsdl.account.ActivityResult[] getActivity() {
        return activity;
    }
     ...
     * @param activity
     */
    public void setActivity(com.invessence.ws.provider.gemini.wsdl.account.ActivityResult[] activity) {
        this.activity = activity;
    }
