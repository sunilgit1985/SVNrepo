...
public class AdvisorLogin_ActiveAccounts_BB {
    ...
    public String [][] createData() throws IllegalFormatException, IOException, EncryptedDocumentException, InvalidFormatException, IllegalClassFormatException {
		...
		myXLPath = Utility.readTestDataFromProperties("Properties/testdatalocation.properties","advisorlogin_activeaccount");
...
public void activeaccountverificcation (String TCID,String vURL,String vBrowser,String username,String password,
		String accounttype,String acctnum,String lname,String fname,String strategy,String goal,
		String investedamount,String vlogo,String Execute,String Results) throws Exception {
		...
		try{			
			...
			// Open the browser
				...
				else
				{
					...
					AdvisorLoginPO.active(driver, accounttype, acctnum, lname, fname, strategy,goal,investedamount,vlogo);
