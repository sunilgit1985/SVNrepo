...
public class AdvisorLogin_BB {
    ...
    public String [][] createData() throws IllegalFormatException, IOException, EncryptedDocumentException, InvalidFormatException, IllegalClassFormatException {
		...
		myXLPath = Utility.readTestDataFromProperties("Properties/testdatalocation.properties","advisorlogin");
...
public void advisorlogin (String TCID,String vURL,String vBrowser,String username,String password,
