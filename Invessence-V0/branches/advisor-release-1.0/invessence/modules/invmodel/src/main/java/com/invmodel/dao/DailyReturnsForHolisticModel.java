...
public class DailyReturnsForHolisticModel
{
   ...
   private static DailyReturnsForHolisticModel instance = null;
   private final Logger logger = Logger.getLogger(DailyReturnsForHolisticModel.class.getName());

   private final ReentrantReadWriteLock readWriteLock = new ReentrantReadWriteLock();
   private final Lock read = readWriteLock.readLock();
   private final Lock write = readWriteLock.writeLock();

   public static synchronized DailyReturnsForHolisticModel getInstance()
   {
      if (instance == null)
      {
         instance = new DailyReturnsForHolisticModel();
      }
      return instance;
   }

   public DailyReturnsForHolisticModel()
   {
      loadDataFromDB();
   }
