...
public class RiskStaticData
{
      ...
      private List<RiskQuestions> listOfQuestion;
      ...
      public RiskStaticData()
      {
         try
         {
            for (Integer question_num = 0; question_num < _Questions.length; question_num++) {
               RiskQuestions rskquest = new RiskQuestions(question_num,_Questions[question_num][0],
                                                          _Choices[question_num],
                                                          risk_Value_Matrix[question_num]);
            }
   ...
   public List<RiskQuestions> getListOfQuestion()
   {
      return listOfQuestion;
   }

   public void setListOfQuestion(List<RiskQuestions> listOfQuestion)
   {
