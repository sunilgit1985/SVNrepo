...
public class SuccessorBeneficiaryCollectionRequest  implements java.io.Serializable {
    private com.invessence.ws.provider.gemini.wsdl.account.SuccessorBeneficiaryRequest[] successorBeneficiary;

    public SuccessorBeneficiaryCollectionRequest() {
    }

    public SuccessorBeneficiaryCollectionRequest(
           com.invessence.ws.provider.gemini.wsdl.account.SuccessorBeneficiaryRequest[] successorBeneficiary) {
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.SuccessorBeneficiaryRequest[] getSuccessorBeneficiary() {
        return successorBeneficiary;
    }
     ...
     */
    public void setSuccessorBeneficiary(com.invessence.ws.provider.gemini.wsdl.account.SuccessorBeneficiaryRequest[] successorBeneficiary) {
        this.successorBeneficiary = successorBeneficiary;
    }
