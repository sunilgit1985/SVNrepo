...
UPDATE `invdb`.`web_advisor_mapping` SET `value`='support@traditioncm.com' WHERE `advisor`='BB-TCM' and`name`='EMAIL.SUPPORT';
UPDATE `invdb`.`web_advisor_mapping` SET `value`='(908) 598-0909' WHERE `advisor`='BB-TCM' and`name`='PHONE.SUPPORT';