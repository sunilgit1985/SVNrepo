 ...
 */
@Entity
@Table(name = "aggr_mx_audit", catalog = "invdb")
public class MXAudit
{
   private Integer id;
   ...
   public MXAudit(Integer id, String reqFor, String reqObj, String resObj, String status, String remarks, Date reqTime, Date resTime, Integer resStatusCode)
   {
      this.id = id;
      this.reqFor = reqFor;
      this.reqObj = reqObj;
