...
public class PendingOrderCollectionResult  implements java.io.Serializable {
    private com.invessence.ws.provider.gemini.wsdl.account.PendingOrderResult[] pendingOrder;
    ...
    public PendingOrderCollectionResult(
           com.invessence.ws.provider.gemini.wsdl.account.PendingOrderResult[] pendingOrder,
     ...
     * @return pendingOrder
     */
    public com.invessence.ws.provider.gemini.wsdl.account.PendingOrderResult[] getPendingOrder() {
        return pendingOrder;
    }
     ...
     * @param pendingOrder
     */
    public void setPendingOrder(com.invessence.ws.provider.gemini.wsdl.account.PendingOrderResult[] pendingOrder) {
        this.pendingOrder = pendingOrder;
    }
