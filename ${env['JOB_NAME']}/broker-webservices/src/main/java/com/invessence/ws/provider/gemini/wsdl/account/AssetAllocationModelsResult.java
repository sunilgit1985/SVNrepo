...
public class AssetAllocationModelsResult  implements java.io.Serializable {
    ...
    private com.invessence.ws.provider.gemini.wsdl.account.AssetAllocationFundsResult[] assetAllocationFunds;

    private com.invessence.ws.provider.gemini.wsdl.account.AccountAssetAllocationModelWeightsResult[] accountAssetAllocationModelWeightsCollection;
    ...
    public AssetAllocationModelsResult(
           ...
           com.invessence.ws.provider.gemini.wsdl.account.AssetAllocationFundsResult[] assetAllocationFunds,
           com.invessence.ws.provider.gemini.wsdl.account.AccountAssetAllocationModelWeightsResult[] accountAssetAllocationModelWeightsCollection,
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.AssetAllocationFundsResult[] getAssetAllocationFunds() {
        return assetAllocationFunds;
    }
     ...
     */
    public void setAssetAllocationFunds(com.invessence.ws.provider.gemini.wsdl.account.AssetAllocationFundsResult[] assetAllocationFunds) {
        this.assetAllocationFunds = assetAllocationFunds;
    }
     ...
     */
    public com.invessence.ws.provider.gemini.wsdl.account.AccountAssetAllocationModelWeightsResult[] getAccountAssetAllocationModelWeightsCollection() {
        return accountAssetAllocationModelWeightsCollection;
    }
     ...
     */
    public void setAccountAssetAllocationModelWeightsCollection(com.invessence.ws.provider.gemini.wsdl.account.AccountAssetAllocationModelWeightsResult[] accountAssetAllocationModelWeightsCollection) {
        this.accountAssetAllocationModelWeightsCollection = accountAssetAllocationModelWeightsCollection;
    }
