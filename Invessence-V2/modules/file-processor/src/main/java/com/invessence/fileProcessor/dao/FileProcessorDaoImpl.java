...
//      try {
//
//         switchDetailsLst = invJdbcTemplate.query(getSwitchDetails, ParameterizedBeanPropertyRowMapper.newInstance(SwitchDetails.class));
...
//         lst = invJdbcTemplate.query(getServiceConfigDetailsAll, new Object[]{serviceMode, company}, ParameterizedBeanPropertyRowMapper.newInstance(ServiceConfigDetails.class));
//      }else{
//         logger.debug("getServiceConfigDetails = " + getServiceConfigDetails);
//         lst = invJdbcTemplate.query(getServiceConfigDetails, new Object[]{serviceMode, company, service}, ParameterizedBeanPropertyRowMapper.newInstance(ServiceConfigDetails.class));
//      }
//      return lst;
//   }
//
...
//         NamedParameterJdbcTemplate npjt=new NamedParameterJdbcTemplate(invJdbcTemplate);
////         lst = invJdbcTemplate.query(getServiceConfigDetailsWherClause, new Object[]{serviceMode, company, Collections.singletonMap("names", service)},  ParameterizedBeanPropertyRowMapper.newInstance(ServiceConfigDetails.class));
...
//      lst = invJdbcTemplate.query(getServiceOperationDetails, new Object[]{company}, ParameterizedBeanPropertyRowMapper.newInstance(ServiceOperationDetails.class));
//      return lst;
//   }
//
...
//      lst = invJdbcTemplate.query(getWebConfigDetails, new Object[]{serviceMode,company}, ParameterizedBeanPropertyRowMapper.newInstance(WebConfigDetails.class));
//      return lst;
//   }
//
//   @Override
...
//      lst = invJdbcTemplate.query(getDCTemplateDetails, new Object[]{serviceMode,company}, ParameterizedBeanPropertyRowMapper.newInstance(DCTemplateDetails.class));
...
//      lst = invJdbcTemplate.query(getDCTemplateMapping, new Object[]{tempCode}, ParameterizedBeanPropertyRowMapper.newInstance(DCTemplateMapping.class));
////      if(lst !=null && lst.size()>0){
////         map=new HashMap<>();
...
//      lst = invJdbcTemplate.query(getDCDocumentDetails, new Object[]{company}, ParameterizedBeanPropertyRowMapper.newInstance(DCDocumentDetails.class));
//      if(lst !=null && lst.size()>0){
...
//      lst = invJdbcTemplate.query(getDCDocumentMapping, new Object[]{tempCode}, ParameterizedBeanPropertyRowMapper.newInstance(DCDocumentMapping.class));
//
...
//      lst = invJdbcTemplate.query(getLookupDetails, ParameterizedBeanPropertyRowMapper.newInstance(LookupDetails.class));
//      return lst;
//   }
//
//
...
//   lst = invJdbcTemplate.query(getServiceConfigDetailsNew, ParameterizedBeanPropertyRowMapper.newInstance(ServiceConfigDetails.class));
//
//   return lst;
//}
//
...
//      lst = invJdbcTemplate.query(getExceptionExternalDetails, new Object[]{service,vendor}, ParameterizedBeanPropertyRowMapper.newInstance(ExceptionExternal.class));
//
//      return lst;
//   }
//
...
//      lst = invJdbcTemplate.query(getExceptionInternalDetails, ParameterizedBeanPropertyRowMapper.newInstance(ExceptionInternal.class));
//
//      return lst;
//   }
   ...
   public Map<String, DBParameters> getDBParametres() throws SQLException
   {
      ...
      dbParamsLst = invJdbcTemplate.query(sql, BeanPropertyRowMapper.newInstance(DBParameters.class));
...
//      try
//      {
//         ServiceSP serviceSP = new ServiceSP(invJdbcTemplate,"sel_service_details", 0);
//         try
//         {
