...
(function (d)
{
...
})(function (d)
   {
       ...
       d.SVGRenderer.prototype.cuboidPath = function (c)
       {
           ...
           var a = c.x, e = c.y, f = c.z, g = c.height, h = c.width, j = c.depth, k = d.map, i = [{x: a, y: e, z: f}, {
               x: a + h,
               y: e,
               z: f
           }, {x: a + h, y: e + g, z: f}, {x: a, y: e + g, z: f}, {x: a, y: e + g, z: f + j}, {x: a + h, y: e + g, z: f + j}, {
               x: a + h,
               y: e,
               z: f + j
           }, {x: a, y: e, z: f + j}], i = o(i, d.charts[this.chartIndex], c.insidePlotArea), f = function (a, c)
           {
               var e = [], a = k(a, b),
                       c = k(c, b);
               I(a) < 0 ? e = a : I(c) < 0 && (e = c);
       ...
       d.SVGRenderer.prototype.arc3d = function (c)
       {
           ...
           K(a, "animate", function (a, c, e, d)
           {
               ...
               if (e.duration && (c = G(c), f = b(c)))l = f, e.step = function (a, b)
               {
                   ...
                   b.elem.setPaths(G(m, {x: c("x"), y: c("y"), r: c("r"), innerR: c("innerR"), start: c("start"), end: c("end")}))
               };
       ...
       d.wrap(d.Chart.prototype, "renderSeries", function (c)
       {
           var b =
                   this.series.length;
           if (this.is3d())for (; b--;)c = this.series[b], c.translate(), c.render();
           else c.call(this)
       });
       ...
       d.wrap(d.seriesTypes.pie.prototype, "translate", function (c)
       {
           ...
           if (this.chart.is3d())
           {
               ...
               A(b.data, function (c)
               {
                   ...
                   f.center = b.center;
                   f = (f.end + f.start) / 2;
                   c.slicedTranslation = {translateX: L(l(f) * a.slicedOffset * l(g * B)), translateY: L(r(f) * a.slicedOffset * l(g * B))}
               })
           }
       });
