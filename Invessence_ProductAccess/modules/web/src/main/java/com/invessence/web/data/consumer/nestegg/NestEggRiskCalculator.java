 ...
 */
public class NestEggRiskCalculator extends RiskCalculator
{
   ...
   public NestEggRiskCalculator(String goal,
   ...
   public NestEggRiskCalculator(Integer numberofQuestions)
   {
